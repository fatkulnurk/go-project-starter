...
func (h *handler) forgotPassword(w http.ResponseWriter, r *http.Request) {
	...
	res, err := h.deps.ForgotPassword.Execute(r.Context(), command.ForgotPasswordCommand{
...
func (h *handler) resetPassword(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.deps.ResetPassword.Execute(r.Context(), command.ResetPasswordCommand{
