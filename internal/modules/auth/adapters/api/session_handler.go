...
func (h *handler) refresh(w http.ResponseWriter, r *http.Request) {
	...
	res, err := h.deps.Refresh.Execute(r.Context(), commands.RefreshCommand{RefreshToken: req.RefreshToken})
	if err != nil {
		writeError(w, err)
		return
	}
...
func (h *handler) logout(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.deps.Logout.Execute(r.Context(), commands.LogoutCommand{
		UserID:       id.UserID,
