...
func NewResetPassword(users domain.UserRepository, codes domain.VerificationCodeRepository, refreshTokens domain.RefreshTokenRepository, hasher hash.PasswordHasher, auditor audit.Recorder, clk clock.Clock, otpMaxAttempts int) *ResetPassword {
